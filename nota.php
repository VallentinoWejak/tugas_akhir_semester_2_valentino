...
");
					...
					<?php
						$nomor++; // Increment the row number
					}
					?>
			...
			<div style="text-align: right;">
				Ongkir : Rp. <?php echo $detail['tarif']; ?> <br>
				<b>Grand Total : Rp. <?php echo $detail['total_pembelian']; ?> </b>
			</div>
